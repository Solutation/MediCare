...
import styles from './ReactionManagement.module.scss';
    ...
    return (
        <>
            <div className={cx('d-flex', 'flex-column', 'w-100', 'p-4')}>
                <h2 className={cx('fw-bold')}>Quản lý phản ứng bài đăng</h2>
                <hr />
                    ...
                    <table className={cx('table', 'table-bordered')}>
                        <thead className={cx('table-primary')}>
                            <tr className={cx('text-center')}>
                                ...
                                <th style={{ width: '8%' }}>User_id</th>
                                <th style={{ width: '8%' }}>Post_id</th>
                                <th style={{ width: '16%' }}>Loại cảm xúc</th>
