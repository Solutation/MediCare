...
import styles from './ConsultantCategoryManagement.module.scss';
import { Button } from '~/components/Button';

const cx = classNames.bind(styles);

const ConsultantCategoryManagement = () => {
    return (
        <>
            <div className={cx('d-flex', 'flex-column', 'w-100', 'p-4')}>
                <h2 className={cx('fw-bold')}>Quản lý chuyên môn chuyên gia</h2>
                <hr />
                <div className={cx('search_wrapper')}>
                    <button className={cx('search_icon')}>
                        <FontAwesomeIcon icon={faMagnifyingGlass} />
                    </button>
                    <input type="text" placeholder="Tìm kiếm chuyên môn chuyên gia" className={cx('search_input')} />
                    ...
                    <table className={cx('table', 'table-bordered')}>
                        <thead className={cx('table-primary')}>
                            <tr className={cx('text-center')}>
                                ...
                                <th style={{ width: '8%' }}>Category_id</th>
...
export default ConsultantCategoryManagement;
