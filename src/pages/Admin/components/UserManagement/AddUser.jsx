            ...
            <div className={cx('wrapper')}>
                <div className={cx('p-2', 'd-flex', 'flex-column')}>
                    <div className={cx('d-flex', 'justify-content-between', 'py-2', 'mt-2')}>
                        <h2 className={cx('fw-bold', 'ms-3')}>Thêm người dùng</h2>
                        <FontAwesomeIcon
                            icon={faXmark}
                            ...
                            <Form action="" className={cx('px-3')}>
                                <div className={cx('row')}>
                                    ...
                                    >
                                        ...
                                        <div className={cx('d-flex', 'flex-column', 'px-5')} style={{ width: '70%' }}>
                                            ...
                                            <div className={cx('form_input_group')}>
                                                <Field className={cx('form_input_date')} name="birth_day" type="date" />
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div style={{ padding: '1rem 0.6rem', width: '10%' }}>
