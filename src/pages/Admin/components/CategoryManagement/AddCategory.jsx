...
let imageCategory =
    'https://firebasestorage.googleapis.com/v0/b/medicare-d0b4b.appspot.com/o/image-ui%2Fdisease2.jpg?alt=media&token=d714f572-ec28-48c6-a131-1ab4175ec029';

const AddCategory = ({ setAddCategory, checkUpdate, setCheckUpdate, setAddCategoryAlert }) => {
    ...
    const handleSubmit = async (formData) => {
        try {
            ...
            await httpRequest.post(`/admin/category/add`, dataToSend);
            setLoading(false);
        ...
        <>
            {initialValues && (
                <div className={cx('blur')}>
                            ...
                            >
                                <Form>
                                    ...
                                    <div className={cx('d-flex', 'w-100', 'justify-content-center', 'mt-5')}>
                                        ...
                                        <div className={cx('px-5')} onClick={() => setAddCategory(false)}>
                    ...
                    {loading && <Loading messageLoading="Đang thực hiện thêm chuyên mục" />}
                </div>
            )}
        </>
    );
