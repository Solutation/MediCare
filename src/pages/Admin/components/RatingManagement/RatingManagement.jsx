                    ...
                    <table className={cx('table', 'table-bordered')}>
                        <thead className={cx('table-primary')}>
                            <tr className={cx('text-center')}>
                                ...
                                <th style={{ width: '6%' }}>User_id</th>
                                <th style={{ width: '6%' }}>Consultant_id</th>
                                <th style={{ width: '6%' }}>Điểm đánh giá</th>
                                <th style={{ width: '60%' }}>Nội dung đánh giá</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>4.6</td>
                                <td>
                                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ullam commodi dolorum rem.
                                    Ex, laborum optio!
                                </td>
                                <td>
                                    <div
