    ...
    return (
        <>
            <div className={cx('d-flex', 'flex-column', 'w-100', 'p-4')}>
                <h2 className={cx('fw-bold')}>Quản lý bài đăng</h2>
                <hr />
                    ...
                    <table className={cx('table', 'table-bordered')}>
                        <thead className={cx('table-primary')}>
                            <tr className={cx('text-center')}>
                                ...
                                <th>Category_id</th>
                                <th style={{ width: '26%' }}>Tiêu đề bài đăng</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>2</td>
                                <td>
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore adipisci impedit
                                    odio vel, facilis necessitatibus.
                                </td>
                                <td>
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut inventore autem
                                    consectetur pariatur? Cumque corrupti cupiditate, odit voluptatem nam, iusto natus
                                    laboriosam obcaecati excepturi dolor ad voluptate impedit. Molestiae expedita animi
                                    culpa nesciunt id sint hic facere inventore minus enim.
                                </td>
                                <td>2</td>
                                <td>1</td>
                                <td>
