...
import styles from './ImagePostManagement.module.scss';
import { Button } from '~/components/Button';

const cx = classNames.bind(styles);

const ImagePostManagement = () => {
    return (
        <>
            <div className={cx('d-flex', 'flex-column', 'w-100', 'p-4')}>
                <h2 className={cx('fw-bold')}>Quản lý ảnh bài đăng</h2>
                <hr />
                <div className={cx('search_wrapper')}>
                    <button className={cx('search_icon')}>
                        <FontAwesomeIcon icon={faMagnifyingGlass} />
                    </button>
                    <input type="text" placeholder="Tìm kiếm ảnh bài đăng" className={cx('search_input')} />
                    ...
                    <table className={cx('table', 'table-bordered')}>
                        <thead className={cx('table-primary')}>
                            <tr className={cx('text-center')}>
                                ...
                                <th style={{ width: '8%' }}>Post_id</th>
                                <th style={{ width: '40%' }}>Ảnh bài đăng</th>
...
export default ImagePostManagement;
